...
export default {
  ...
  methods: {
      ...
      cambiarsistema(id) {
        axios
        .post('https://api-ttps.herokuapp.com/cambiarsistema', {idsistemaactual: this.idsistema, idsistema: id, idpaciente: this.idpaciente},{headers: { "user_token": sessionStorage.token }})
        .then(response => {
          this.cambio = true;
        ...
        .catch(error => {
          if (id === 3){
            axios
            .post('https://api-ttps.herokuapp.com/cambiarsistema', {idsistema: 1, idpaciente: this.idpaciente},{headers: { "user_token": sessionStorage.token }})
            .then(response => {
               this.cambiouti = true;
               this.cama= response.data.numerocama;
               this.sala= response.data.nombresala
